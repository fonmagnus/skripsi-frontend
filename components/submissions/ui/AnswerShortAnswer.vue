<template>
  <div class="flex flex-column">
    ...
    <div v-if="$vuetify.breakpoint.mdAndUp" class="flex centered-items start-content">
      <vs-input 
        v-model="answer.body" 
        class="ma-3" 
        label="Jawaban" 
        readonly
        :state="answer.body.toLowerCase() == answer.question.answer_key.toLowerCase() ? 'success' : 'danger'"
      >
      </vs-input>
      <vs-input 
